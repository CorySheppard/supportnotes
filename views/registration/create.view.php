    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 ">
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h2 class="mt-5 text-center text-2xl/9 font-bold tracking-tight text-gray-800">Register a New Account</h2>
            </div>
            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <form action="/register" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="username" class="absolute -left-[1000px] top-auto w-[1px] h-[1px] overflow-hidden">Username</label>
                        <input id="username" type="text" name="username" placeholder="Username" required class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6" />
                        
                        <!-- Name Errors -->
                        
                        <?php if (isset($errors['username'])) : ?>
                            <p class="text-sm text-red-500 pt-2"><?= $errors['username'] ?></p>
                        <?php endif ?>
                    </div>
                    ...
                    <div>
                        <button type="submit" class="w-full rounded-md bg-gray-800 px-4 py-2 text-sm font-semibold text-white shadow-xs cursor-pointer hover:bg-gray-600">Register</button>
                    </div>
                </form>
            </div>
        </div>
