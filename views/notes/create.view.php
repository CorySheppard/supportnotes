    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <form method="POST" action="/notes">
            ...
            <div class="space-y-12">
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 border-b border-gray-900/10 pb-8">
                    ...
                    <div class="col-span-full space-y-2">
                        ...
                        <textarea id="content" name="content" rows="3" required class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-600 sm:text-sm/6"><?= $_POST['content'] ?? '' ?></textarea>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button type="submit" class="rounded-md bg-gray-800 px-4 py-2 text-sm font-semibold text-white shadow-xs cursor-pointer hover:bg-gray-600">Save</button>
            </div>
        </form>
    </div>
</main>
